...
# -p tham số tiền xử lý ảnh (có thể bỏ qua nếu không
# cần). Nếu dùng: blur : Làm mờ ảnh để giảm noise, thresh: Phân tách đen trắng
...
cv2.waitKey(0)
#Run: python py_ocr.py -i miai.png -p thresh
